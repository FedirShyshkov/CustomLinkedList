...
namespace CustomLinkedList.Tests
{
    public class MyDoubleLinkedListTests : IDisposable
    {
        ...
        {
            Assert.Throws<LinkedListException>(() => { var sut = new MyDoubleLinkedList<StubType, StubNode<StubType>>(); });
        }

        [Fact]
        public void AddBefore_should_throw_ArgumentNull_exception_if_null_supplied_instead_of_node()
        {
            var sut = new MyDoubleLinkedList<StubType, MyDoubleLinkedListNode<StubType>>();
